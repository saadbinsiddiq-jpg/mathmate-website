(function () {
  ...
  var T = {
    en: {
      ...
      page_data_deletion: 'Data Deletion Instructions',
      ft_snap: 'Snap & Solve',
      ...
      ft_privacy: 'Privacy',
      ft_terms: 'Terms',
      ft_data_deletion: 'Data Deletion',
      ft_how: 'How It Works',
      ft_faq: 'FAQ',
      ft_blog: 'Blog',
      ...
      lbl_dl_free: 'Download Free',
      lbl_dl_on: 'Download on the',
      lbl_get_on: 'Get it on',
      lbl_premium: 'Premium',
      lbl_premium_feat: 'Premium Feature',
      lbl_why_helps: 'Why It Helps',
      lbl_get_app_free: 'Get the App Free',
    ...
    fr: {
      ...
      page_data_deletion: 'Instructions de Suppression des Données',
      ...
      ft_terms: 'Conditions',
      ft_data_deletion: 'Suppression des Données',
      ...
      lbl_dl_free: 'Télécharger Gratuitement',
      lbl_dl_on: "Télécharger sur l'",
      lbl_get_on: 'Disponible sur',
      lbl_premium: 'Premium',
      lbl_premium_feat: 'Fonctionnalité Premium',
      lbl_why_helps: 'Pourquoi ça Aide',
      lbl_get_app_free: "Télécharger l'App Gratuitement",
    ...
    ar: {
      ...
      page_data_deletion: 'تعليمات حذف البيانات',
      ft_snap: 'التقط وحلّ',
      ft_steps: 'خطوة بخطوة',
      ft_gallery: 'المعرض',
      ...
      lbl_free_start: 'مجاني للبدء',
      lbl_free_to_start: 'مجاني للبدء',
      lbl_dl_free: 'تحميل مجاني',
      lbl_dl_on: 'حمّل من',
      lbl_get_on: 'متاح على',
      lbl_premium: 'بريميوم',
      lbl_premium_feat: 'ميزة مدفوعة',
      lbl_why_helps: 'لماذا يساعد',
      lbl_get_app_free: 'احصل على التطبيق مجاناً',
      lbl_contact_us: 'تواصل معنا',
    }
  };
